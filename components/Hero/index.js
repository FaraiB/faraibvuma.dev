...
const Hero = () => {
    return(
        ...
        <div>
            <h1 className='text-white bold text-4xl pt-4 px-4'>Olá, eu sou o Farai Bvuma</h1>
            <h2 className='text-white font  text-3xl uppercase px-4'>Desenvolvedor Fullstack</h2>
